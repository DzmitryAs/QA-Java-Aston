...
public class MtsByTest {
    ...
    public void moveToFrame() {
        ...
        wait.un til(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/app-root/div/div/app-payment-container/app-header/header/div/div/div/span[1]")));
